...
func (c *fileServiceClient) DownloadFile(ctx context.Context, in *DownloadRequest, opts ...grpc.CallOption) (FileService_DownloadFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &FileService_ServiceDesc.Streams[0], "/proto.filedownload.FileService/DownloadFile", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *fileServiceClient) Watch(ctx context.Context, in *FileWatchRequest, opts ...grpc.CallOption) (FileService_WatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &FileService_ServiceDesc.Streams[1], "/proto.filedownload.FileService/Watch", opts...)
	if err != nil {
		return nil, err
	}
